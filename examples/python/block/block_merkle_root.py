...
Example: (return as bytearray)
    Test Invoke:            build /path/to/block-merkle-root.py test 02 05 False False 1
...
Example: (return as integer)
    Test Invoke:            build /path/to/block-merkle-root.py test 02 02 False False 1
...
def Main(height):
    ...
    :type height: int
    :return: Block merkle root of the input block height
    :rtype: bytearray
    """
