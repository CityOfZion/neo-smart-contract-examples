...
Example Build Command: `./contracts/python/02-number/add.py test 0505 02 False False 2 5`
Example Import Command: `import contract ./contracts/python/02-number/add.py 0505 02 False False`
